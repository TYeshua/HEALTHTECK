...
export const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-subtle">
      {/* 1. MELHORIA: Fundo animado (em vez de estático) */}
      <div className="absolute inset-0">
        <motion.div
          className="absolute top-20 left-10 w-72 h-72 bg-primary rounded-full blur-3xl"
          // Animação de "flutuação" lenta e constante
          animate={{
      ...
      <div className="container mx-auto px-6 py-32 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Sistema de classificação de risco médica com IA que combina protocolos validados e
            machine learning para priorização precisa e diagnóstico assistido em
            tempo real
          </motion.p>
          ...
          >
            <Link to="/kiosk">
              {/* 3. MELHORIA: Sombra "Glow" no botão principal */}
              <Button
                size="lg"
                className="group shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/40 transition-all duration-300"
              >
                Iniciar Triagem
          ...
          >
            {/* 4. MELHORIA: Efeito "lift" (elevar) no hover dos cards */}
